...
\setboolean{shading}{true}
 ...
 membership\_service}\moduleRightDash\@xx{}%
\@x{}%
\@y{%
...
\@xx{}%
\@x{ {\EXTENDS} Integers}%
\@x{ {\VARIABLE} node ,\, chan}%
\@x{ {\CONSTANT} IP ,\, Data ,\, ADD\_Request ,\, ACK\_Response}%
\@pvspace{8.0pt}%
 \@x{ TypeInvariant \.{\defeq} \.{\land} node \.{\in} [ type \.{:} \{ 1 ,\, 2
 \} ,\, rdy \.{:} \{ 0 ,\, 1 \} ,\, ack \.{:} \{ 0 ,\, 1 \} ,\, ip \.{:} IP
 ]}%
\@y{%
 node has \ensuremath{IP}, it is either a Leader or a Peer
}%
\@xx{}%
\@x{\@s{80.80} \.{\land} IPs \.{=} IP}%
 \@x{\@s{80.80} \.{\land} chan \.{\in} [ type \.{:} \{ 1 ,\, 2 \} ,\, rdy
 \.{:} \{ 0 ,\, 1 \} ,\, ack \.{:} \{ 0 ,\, 1 \} ,\, val \.{:} \{ {\langle}
 {\rangle} ,\, {\langle} IPs ,\, IPd {\rangle} ,\, {\langle} IP ,\,
 MembershipList {\rangle} \} ]}%
\@y{}%
\@xx{}%
\begin{lcom}{42.5}%
\begin{cpar}{0}{T}{F}{5.0}{0}{}%
\ensuremath{chan} is either of sending type or receiving type
\end{cpar}%
\begin{cpar}{1}{F}{F}{0}{0}{}%
 \ensuremath{chan} carries either empty value (when it\mbox{'}s not in use),
 [\ensuremath{IPs} and \ensuremath{IPs}]
 (when sending ADD request, source \ensuremath{IP}: \ensuremath{IPs
 } , destination \ensuremath{IP}: \ensuremath{IPd}), or [\ensuremath{IPs},
 \ensuremath{IPd} and Membership
 list] (when sending regular heartbeats)
\end{cpar}%
\end{lcom}%
\@x{ LeaderInit \.{\defeq} \.{\lor} \.{\land} node . type\@s{0.52} \.{=} 1}%
\@x{\@s{79.80} \.{\land} node . rdy \.{=} node . ack}%
\@y{\@s{0}%
 Leader begins in listening mode: Listening for ADD req
}%
\@xx{}%
\@x{\@s{79.80} \.{\land} node . membership \.{=} {\langle} {\rangle}}%
\@y{\@s{0}%
 Leader begins with empty membership list
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ PeerInit \.{\defeq} \.{\lor} \.{\land} node . type \.{=} 2}%
\@x{\@s{66.50} \.{\land} node . rdy \.{=} node . ack}%
\@y{\@s{0}%
 Peer begins in listening mode: Listening for \ensuremath{ACK} res
}%
\@xx{}%
\@x{\@s{66.50} \.{\land} node . membership \.{=} {\langle} {\rangle}}%
\@y{\@s{0}%
 Peer begins with empty membership list
}%
\@xx{}%
\@pvspace{8.0pt}%
\@x{ PeerSendAddReq ( d ) \.{\defeq} \.{\land} PeerInit}%
\@x{\@s{106.95} \.{\land} d \.{=} ADD\_Request}%
 \@x{\@s{106.95} \.{\land} chan \.{'} \.{=} [ chan {\EXCEPT} {\bang} . val
 \.{=} Append ( @ ,\, IP ) ,\, {\bang} . rdy \.{=} 1 \.{-} @ ]}%
\@x{ LeaderReceiveAddEvent\@s{2.02} \.{\defeq} \.{\lor} \.{\land} LeaderInit}%
 \@x{\@s{135.76} \.{\land} node \.{'} \.{=} [ node {\EXCEPT} {\bang} . ack
 \.{=} 1 \.{-} @ ]}%
\@x{ LeaderSendAckEvent ( d ) \.{\defeq} \.{\land} LeaderReceiveAddEvent}%
\@x{\@s{124.65} \.{\land}}%
\@y{\@s{0}%
 send \ensuremath{ack} to the machine that sent ADD request
}%
\@xx{}%
\@x{ PeerReceiveAckEvent \.{\defeq} \.{\land} PeerSendAddReq}%
\@x{\@s{112.40} \.{\land}}%
\@y{\@s{0}%
 peer do something after receiving \ensuremath{ACK} response
}%
\@xx{}%
\@x{ PeerSendRegularHb \.{\defeq} \.{\land} PeerReceiveAckEvent}%
\@x{\@s{104.91} \.{\land}}%
\@y{%
 what to send in the regular \ensuremath{Hb}\.{?}
}%
\@xx{}%
\@x{ PeerReceiveRegularHb \.{\defeq} \.{\land} PeerReceiveAckEvent}%
\@x{\@s{96.90} \.{\land}\@s{7.77}}%
\@y{%
 what to do with received \ensuremath{Hb}\.{?}
}%
\@xx{}%
\@x{ LeaderNext \.{\defeq} \.{\land} LeaderReceiveAddEvent}%
 \@x{\@s{68.72} \.{\land} node \.{'} \.{=} [ node {\EXCEPT} {\bang} .
 membership \.{=} Append ( @ ,\, chan . val . IPs ) ]}%
 \@x{ LeaderSendRegularHb \.{\defeq} \.{\land} ( \exists\, d \.{\in} Data
 \.{:} LeaderSendAckEvent ( d ) )}%
\@x{\@s{114.11} \.{\land}}%
\@y{\@s{0}%
 What to send in regular \ensuremath{HB} as a Leader
}%
\@xx{}%
 \@x{ LeaderReceiveRegularHb \.{\defeq} \.{\land} ( \exists\, d \.{\in} Data
 \.{:} LeaderSendAckEvent ( d ) )}%
\@x{\@s{106.10} \.{\land}\@s{7.77}}%
\@y{\@s{0}%
 What to do with received regular \ensuremath{HB} as a Leader
}%
\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{T}{F}{5.0}{0}{}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
3. Peer knows about the Leader\mbox{'}s \ensuremath{Ip} address
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 4. Peer begins by sending ADD request to Leader, ADD request carries
 requester\mbox{'}s \ensuremath{IP} address.
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 7. Leader updates its membership list with thie Peer i\mbox{'}s
 \ensuremath{IP} Address and timestamp
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 8. Leader sends \ensuremath{ACK} with current membership list of
 \ensuremath{Ip} Addresses and timestamps
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 11. All Peers send heartbeat messages to two \ensuremath{Ip} addresses higher
 than itself, mod calculations is considered
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 12. All Peers receive heartbeat messages from two peers less than itself, mod
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Apr} 11 13:33:58 \ensuremath{PDT} 2018 by \ensuremath{aksin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Tue} \ensuremath{Mar} 27
 15:24:27 \ensuremath{PDT} 2018 by \ensuremath{aksin
}%
\end{cpar}%
\end{lcom}%
\end{document}
